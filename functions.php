...
if ( ! function_exists( 'blogrow_setup' ) ) {
	...
	function blogrow_setup() {
		...
		register_nav_menus( array(
			'mobile' 	=> esc_html__( 'Mobile', 'blogrow' ),
			'topbar' 	=> esc_html__( 'Topbar', 'blogrow' ),
		) );
	}
...
add_action( 'after_setup_theme', 'blogrow_custom_logo' );


/*  Custom header
/* ------------------------------------ */
if ( ! function_exists( 'blogrow_custom_header' ) ) {
	
	function blogrow_custom_header() {
		$args = array(
			'default-image'	=> false,
			'default-text'	=> false,
			'width'			=> 1160,
...
add_action( 'after_setup_theme', 'blogrow_custom_header' );


/*  Custom background
/* ------------------------------------ */
if ( ! function_exists( 'blogrow_custom_background' ) ) {
	
	function blogrow_custom_background() {
		$args = array();
		add_theme_support( 'custom-background', $args );
	}
	
}
add_action( 'after_setup_theme', 'blogrow_custom_background' );
...
add_action( 'wp_enqueue_scripts', 'blogrow_deregister', 100 );
...
if ( ! function_exists( 'blogrow_sidebars' ) ) {
	...
	function blogrow_sidebars()	{
		register_sidebar(array( 'name' => esc_html__('Primary','blogrow'),'id' => 'primary','description' => esc_html__("Normal full width sidebar","blogrow"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>'));
		if ( get_theme_mod('footer-widgets') >= '1' ) { register_sidebar(array( 'name' => esc_html__('Footer 1','blogrow'),'id' => 'footer-1', 'description' => esc_html__("Widgetized footer","blogrow"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '2' ) { register_sidebar(array( 'name' => esc_html__('Footer 2','blogrow'),'id' => 'footer-2', 'description' => esc_html__("Widgetized footer","blogrow"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '3' ) { register_sidebar(array( 'name' => esc_html__('Footer 3','blogrow'),'id' => 'footer-3', 'description' => esc_html__("Widgetized footer","blogrow"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '4' ) { register_sidebar(array( 'name' => esc_html__('Footer 4','blogrow'),'id' => 'footer-4', 'description' => esc_html__("Widgetized footer","blogrow"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
	}
...
/*  Admin panel css
/* ------------------------------------ */
if ( ! function_exists( 'blogrow_admin_panel_css' ) ) {
...
/* ------------------------------------ */
if ( ! function_exists( 'blogrow_admin_panel_widget_css' ) ) {
	
	function blogrow_admin_panel_widget_css( $hook ) {
		if ( 'widgets.php' != $hook ) {
			return;
		}
		wp_enqueue_style( 'blogrow-widgets-admin', get_template_directory_uri().'/functions/widgets/widgets.css' );
	}

}
add_action( 'admin_enqueue_scripts', 'blogrow_admin_panel_widget_css' );
...
if ( ! function_exists( 'blogrow_plugins' ) ) {
	...
	function blogrow_plugins() {	
		if ( get_theme_mod('recommended-plugins','on') =='on' ) { 		
			...
			$plugins = array(
				array(
					'name' => esc_html__( 'Alx Extensions', 'blogrow' ),
					'slug' => 'alx-extensions',
				),
				array(
					'name' => esc_html__( 'Meta Box', 'blogrow' ),
					'slug' => 'meta-box',
				),
				array(
					'name' => esc_html__( 'Regenerate Thumbnails', 'blogrow' ),
