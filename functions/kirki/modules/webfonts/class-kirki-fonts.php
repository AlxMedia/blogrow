...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'blogrow' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'blogrow' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'blogrow' ),
			'200'       => esc_attr__( 'Light 200', 'blogrow' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'blogrow' ),
			'300'       => esc_attr__( 'Book 300', 'blogrow' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'blogrow' ),
			'400'       => esc_attr__( 'Normal 400', 'blogrow' ),
			'regular'   => esc_attr__( 'Normal 400', 'blogrow' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'blogrow' ),
			'500'       => esc_attr__( 'Medium 500', 'blogrow' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'blogrow' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'blogrow' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'blogrow' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'blogrow' ),
			'700'       => esc_attr__( 'Bold 700', 'blogrow' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'blogrow' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'blogrow' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'blogrow' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'blogrow' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'blogrow' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'blogrow' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'blogrow' ),
		);
	}
